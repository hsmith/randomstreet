...
Vector2.distanceSquared = function(v1,v2){
...
Vector2.prototype = {
	...
	divideEqVec : function( v ) {
		this.x /= v.x;
		this.y /= v.y;
	},

	divideNewVec : function( v ) {
		var returnvec = this.clone();
		return returnvec.divideEqVec( v );
	},
